<template>
  <div class="ele-body">
              ...
              <div class="user-account-list">
                <div class="user-account-item ele-cell">
                  <div class="ele-cell-content">
                    ...
                    <div class="ele-text-secondary"  v-if="!loginUser.secure_password_seted" style="color: red;">
                      未设置
                    </div>
                  </div>
                  <el-link type="primary"  @click="securePwdVisible = true;"  v-if="loginUser.secure_password_seted" :underline="false">去设置</el-link>
                  <el-link type="primary"  @click="securePwdVisible = true;"  v-if="!loginUser.secure_password_seted" :underline="false">去修改</el-link>
                </div>
                <el-divider />
                <div class="user-account-item ele-cell">
                  <div class="ele-cell-content">
                    ...
                    <div class="ele-text-secondary" v-if="!loginUser.google_seted"  style="color: red;">
                      未绑定
                    </div>
                  </div>
    ...
    <secure-pwd-modal :visible.sync="securePwdVisible" />
  </div>
...
<script>
  import GoogleAuthModal from './google_auth_modal.vue';
    import SecurePwdModal from './secure_pwd_modal.vue';
  import * as api from '@/api/index';

  export default {
    name: 'UserProfile',
    components: { GoogleAuthModal, SecurePwdModal },
    data() {
      return {
        // tab页选中
        active: 'info',
