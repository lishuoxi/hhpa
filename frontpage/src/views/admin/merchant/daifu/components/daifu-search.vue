    ...
    <el-row :gutter="15">
      <el-col :lg="6" :md="12">
        <el-form-item label="订单号:">
          <el-input clearable v-model="where.daifu_id" placeholder="请输入" />
        </el-form-item>
      </el-col>
      <el-col :lg="6" :md="12">
        <el-form-item label="商户单号:">
          <el-input clearable v-model="where.out_daifu_id" placeholder="请输入" />
        </el-form-item>
      </el-col>
      <el-col :lg="6" :md="12">
      ...
      <el-col :lg="6" :md="12">
        <el-form-item label="商户:">
          <user-select v-model="where.merchant_id" placeholder="请选择" :role-id="2" />
        </el-form-item>
      </el-col>
      <el-col :lg="8" :md="24">
