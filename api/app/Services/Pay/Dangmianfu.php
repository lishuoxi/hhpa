...
class Dangmianfu extends Pay
{
    ...
    protected function generateSign($params, $rsaPrivateKey, $signType = "RSA") {
        return $this->sign($this->getSignContent($params), $rsaPrivateKey, $signType);
    }
    ...
    public function detail($trade)
    {
		...
		$code_url = $result['alipay_trade_precreate_response']['qr_code'];
		
		return view('dangmianfu', ['qrcode_url' => $code_url]);
